...
const playgroundSettingsModal = ref();
...
onClickOutside(playgroundSettingsModal, () => {
  setTimeout(() => {
    emit('closeModal');
  }, 20);
});
...
<template>
  <div
    v-if="openModal"
    ref="playgroundSettingsModal"
    class="max-w-[377px] w-full text-white rounded-md absolute px-6 pt-7 pb-4 top-[-20px] left-0 right-0 sm:left-28 sm:right-auto  mx-auto backdrop-blur-3xl	 bg-[#2d3a35]/80 z-50  border  border-white/20"
  >
    <div
